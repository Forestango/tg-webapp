...
//
// Pets artwork:
// - Put your PNG/WebP into: ./assets/pets/
// - Add "img: 'assets/pets/<file>.png'" into a tier to show an image instead of emoji.
// - If img is missing, UI will fallback to emoji.
(() => {
  'use strict';
  ...
  const LINES = [
    ...
    },
    {
      id: 'dog_husky',
      tiers: [
        // Example: replace placeholder.png with your own artwork
        { name: 'Хаски', emoji: '🐶', img: 'assets/pets/placeholder.png', rate: 1, colorA:'#fbbf24', colorB:'#f97316' },
